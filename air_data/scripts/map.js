...
function addLine(data) {
  for(var row = 0; row < data.length; row++){
    var dst_lat = data[row][latitude];
    var dst_lng = data[row][longitude];
    var line_size = parseInt(data[row][passengers]);
...
function addCircle(data) {
  for(var row = 0; row < 11; row++){
    var latitude = data[row][2];
    var longitude = data[row][3];
    var country = data[row][1];
